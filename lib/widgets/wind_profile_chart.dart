...
/// Speed-vs-altitude profile with a small "wind from" arrow at each layer.
...
class _ProfilePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Profile line (sorted by altitude).
    ...
    // Per-layer marker + "wind from" arrow.
  ...
  /// Draws a short arrow pointing in the direction the wind comes FROM
  /// (bearing 0 = up/North, 90 = right/East).
